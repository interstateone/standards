...
(function() {
  var Check, CheckView, NavBarView, Standards, StandardsRouter, Task, TaskView, Tasks, TasksView, User, WeekDayHeader,
  ...
  Standards.addInitializer(function(options) {
    ...
    return this.user.fetch({
      success: function(collection, response) {
        Standards.navigation.show(_this.navigation = new NavBarView);
